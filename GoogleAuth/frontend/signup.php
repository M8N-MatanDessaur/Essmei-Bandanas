...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    <script src="../assets/javascript/show_password.js"></script>
    <title>Sign up</title>
</head>

<body>
    <section>
        <div class="form flx-row">
            <form action="../backend/signNewUser.php" method="post">
                ...
                <br>
                <div class="flx-row" id="full-name">
                ...
                <br>
                <div class="flx-row" id="password">
                    <input type="password" name="pass" placeholder="Password" id="pass">
                    <input type="password" name="confirm_pass" placeholder="Confirm">
                </div>
                <p>Use 8 or more characters with a mix of letters, numbers & <br> symbols</p>
                <br>
                <input type="checkbox" name="show-pass" id="show_pass">
            ...
            <div class="center">
                <img class="privacy-img" src="https://ssl.gstatic.com/accounts/signup/glif/account.svg">
                <p class="desc-google">One account. All of Google <br> working for you.</p>
            </div>
        </div>
    </section>
</body>
